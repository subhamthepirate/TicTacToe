...
namespace TicTacToe.Api.Services
{
    ...
    public class GameService : IGameService
    {
        ...
        public GameResponse ResetGame(string gameId)
        {
            ...
            // Reset the game state but preserve the scoreboard
            game.ResetGame();
        ...
        private bool TryGetWinningPositions(char[,] board, out List<Position> winningPositions)
        {
            ...
            for (int r = 0; r < 3; r++)
            {
                ...
                {
                    winningPositions.Add(new Position(r, 0));
                    winningPositions.Add(new Position(r, 1));
                    winningPositions.Add(new Position(r, 2));
                    return true;
                }
            }
            // Check columns
            for (int c = 0; c < 3; c++)
            {
                ...
                {
                    winningPositions.Add(new Position(0, c));
                    winningPositions.Add(new Position(1, c));
                    winningPositions.Add(new Position(2, c));
                    return true;
                }
            }
            // Check diagonals
